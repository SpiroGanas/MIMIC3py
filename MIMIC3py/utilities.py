...
def verifyData(fileToVerify, local_save_folder=local_save_folder):
    ...
    try:
        return checksums[fileToVerify] == md5(os.path.join(local_save_folder, fileToVerify))
...
def verifyAll(local_save_folder=local_save_folder):
...
if __name__ == "__main__":
    print(verifyData('D_CPT.csv.gz'))
    print(verifyData('D_CPT.csv.gzsdsdsd'))
    print(verifyData('ADMISSIONS.csv.gz'))